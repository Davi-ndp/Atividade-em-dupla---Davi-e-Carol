...
let combo = 18
let ValorPago = 50
let Restroco = Number(50 - 18)
console.log(`Troco R$ ${Restroco}`)
...
console.log("Meu nome é " + nome + " tenho " + idade + " e moro em " + bairro + ".");
...
function aoClicar() {
   ...
   document.getElementById("saida").textContent = "Bem-vindo(a), " + nomeDigitado + "!";
}
...
let totalFesta = precoPizza + precoRefri;
let valorPorAmigo = totalFesta / amigos;

console.log("Cada um paga: R$ " + valorPorAmigo);
document.getElementById("saida").textContent = "Cada um paga: R$ " + valorPorAmigo;
